...
> Dada a dependência entre as partes relacionadas, <mark style="background:#fff88f">sob nenhum aspecto</mark> o auditor pode se esquivar de obter conhecimento suficiente para concluir que as demonstrações contábeis publicadas estão adequadas.
...
<mark style="background:#d3f8b6">NO CASO FOI UM PAPEL NECESSARIO QUE NAO FOI ACHADO ENTAO O QUE DEVE SER FEITO É SE UTILIZAR DE INDAGAÇÃO POR ESCRITO. </mark>
