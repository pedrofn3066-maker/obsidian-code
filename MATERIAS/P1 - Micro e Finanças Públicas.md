...
>**Em uma batéria de de questões o caio girão (AMIGO DO TEC) disse o seguinte:**    
 ...
 VARIAVEIS EXOGENAS :  O RESTO 
OBS: CUIDADO COM A LETRA B, ELA DIZ PREÇO DO BEM SUBSTITUTO , LOGO ELA ESTÀ DE REFERINDO A OUTRO BEM.
...
### Falhas de mercado e intervenção estatal
- [ ] status [dom:: 0] [peso:: 2]
...
### Política fiscal e multiplicadores
- [ ] status [dom:: 0] [peso:: 2]
...
### Efeitos econômicos da tributação sobre o consumo
- [ ] status [dom:: 0] [peso:: 2]
