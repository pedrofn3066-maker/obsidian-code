...
*Fonte: Guia de Estudo Regular Fiscal 4.0 (VINTEUM) — bancas FCC, FGV e CEBRASPE. Disciplina "Contabilidade Geral e Avançada" no guia.*
...
> [!important] Esta nota é a superfície da **Prova I**, não uma segunda Avançada
> O checklist de 26 tópicos acima é **o mesmo** de [[P2 - Contabilidade Avançada e de Custos]] — o guia VINTEUM trata "Contabilidade Geral e Avançada" como disciplina única, e o vault a partiu em duas notas. A profundidade mora lá; **não se escreve conteúdo de contabilidade aqui**, sob pena de duas cópias que divergem.
>
> O que muda é a prova. Aqui é **P1, peso 2, 20 pontos**, cobrada em nível de *noções* junto com a pública. Cada tópico abaixo diz o que a P1 cobra e aponta para onde estudar. Ver [[MOC - Contabilidades]] para o mapa completo.


# Contabilidade Basica

## Escrituração, partidas dobradas, fatos contábeis
- [ ] status [dom:: 0] [peso:: 2]

Nível P1: reconhecer as formalidades da Lei 6.404 e não trocar **Razão** por **Diário**.

→ [[P2 - Contabilidade Avançada e de Custos#- Escrituração, Balancete, Atos e Fatos;\|Escrituração, Balancete, Atos e Fatos]] — requisitos formais, a tabela Razão × Diário, escrituração resumida em 30 dias.

<mark style="background:#fff88f">Lacuna:</mark> **atos × fatos administrativos** (permutativos, modificativos, mistos) não existe no guia VINTEUM. É justamente o que o título deste tópico promete e o que a P1 tende a cobrar em nível conceitual. Pegar no TEC.


## Balancete de verificação
- [ ] status [dom:: 0] [peso:: 2]

Nível P1: saber que é **auxiliar e não obrigatório**, e que provar partidas dobradas **não** prova escrituração correta.

→ [[P2 - Contabilidade Avançada e de Custos#- Escrituração, Balancete, Atos e Fatos;\|mesma seção]], subitem *Balancete de verificação*.

Os três erros que o balancete **não** detecta — omissão de registro, erro de título, registro em duplicidade — são a questão inteira quando o tema cai.


## Balanço patrimonial e DRE
- [ ] status [dom:: 0] [peso:: 2]

Nível P1: classificar contas nos grupos certos e montar a DRE até o lucro líquido.
...
Nível P1: identificar em qual demonstração cada evento aparece, e as três atividades da DFC.
...
Nível P1: montar o CMV e escolher entre custo e VRL.

→ [[P2 - Contabilidade Avançada e de Custos#- Estoques (CPC 16)\|Estoques (CPC 16)]] — o que compõe o custo de aquisição, VRL, PEAVM.
→ [[P2 - Contabilidade Avançada e de Custos#- Operações com Receitas e Despesas Antecipadas\|Operações com mercadorias]].

Dica do guia para questão de resultado com mercadorias: **resolver por razonete**.


## Imobilizado, depreciação e intangível
- [ ] status [dom:: 0] [peso:: 2]

Nível P1: classificar o bem no grupo certo e calcular depreciação linear. Os três tópicos estão escritos:

→ [[P2 - Contabilidade Avançada e de Custos#- Imobilizado (CPC 27);\|Imobilizado (CPC 27)]] — conceito, itens peculiares, o que entra e não entra no custo, reavaliação.
→ [[P2 - Contabilidade Avançada e de Custos#- Depreciação, Amortização e Exaustão;\|Depreciação, Amortização e Exaustão]] — os quatro métodos, início pela **disponibilidade para uso**, prazos fiscais.
→ [[P2 - Contabilidade Avançada e de Custos#- Intangível (CPC 04);\|Intangível (CPC 04)]] — art. 179, VI. <mark style="background:#ffb8b8">Raso</mark>.

As trocas que a banca explora: terreno sem destinação vai para **Investimentos**; software embarcado é imobilizado e software separável é intangível.

Ótica pública, ambas vazias: [[P2 - CASP#- Imobilizado\|CASP Imobilizado]] · [[P2 - CASP#- Depreciação\|CASP Depreciação]].


## Provisões e reservas
- [ ] status [dom:: 0] [peso:: 2]

Nível P1: separar **provisão** (passivo de prazo ou valor incertos) de **reserva** (conta do PL) — a troca é o erro clássico.
