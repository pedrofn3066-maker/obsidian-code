...
✔ **Submissão à LGPD:** Obrigatória em todas as contratações de TI do governo. 

✔ **Papéis:** <mark style="background:rgba(240, 200, 0, 0.2)">Órgão contratante (Controlador) e Provedor de nuvem (Operador). </mark>

✔ **Responsabilidade:** É sempre **compartilhada** (nunca exclusiva do provedor ou exclusiva do órgão). 
