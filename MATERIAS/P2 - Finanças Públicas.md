...
> ****Zero na âncora BA 2019** — disciplina específica em CE 2026**
> Prioridade: **importante**

Não existia como disciplina autônoma no edital baiano de 2019, mas é bloco específico nos editais FCC recentes. É também onde sua preparação anterior transfere melhor.
...
### Teoria da tributação: eficiência, equidade, progressividade
- [ ] status [dom:: 0] [peso:: 3]

### Incidência tributária e ônus excedente
- [ ] status [dom:: 0] [peso:: 3]

### Tributação sobre consumo, renda e patrimônio
- [ ] status [dom:: 0] [peso:: 3]

### Orçamento público: princípios, PPA, LDO, LOA
- [ ] status [dom:: 0] [peso:: 3]

### Ciclo orçamentário e execução
- [ ] status [dom:: 0] [peso:: 3]
