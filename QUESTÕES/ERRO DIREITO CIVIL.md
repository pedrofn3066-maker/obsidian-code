...
tags:
---
# 📉 Caderno de Erros: [[P1 - Direito Civil]]
...
- **O negócio jurídico firmado com erro de cálculo não permite a anulação do negócio celebrado, mas autoriza a retificação da declaração da vontade.**
	De fato, o erro de cálculo, isto é, o mero erro aritmético, não é causa de anulação do negócio, <font color="#e36c09">apenas autoriza a correção da declaração de vontade</font>, conforme estabelece o art. 143 do CC:

- a) Art. 192. Os prazos de prescrição **não podem ser alterados por acordo das partes**.
	b) Art. 203. A prescrição **pode ser interrompida por qualquer interessado**.
...
- Assim, como decorrência do princípio da gravitação jurídica ("o acessório segue o principal"), "_tudo aquilo que se incorporar ao imóvel em razão de uma ação qualquer cairá sob o domínio do proprietário, pouco importando o valor da construção ou da plantação em relação ao solo"_ (Cf. DINIZ, Maria Helena. Código Civil comentado. 14. ed. São Paulo: Saraiva, 2009, p. 877).
**Portanto, tendo a alienação da fazenda sido realizada "de porteira fechada", ou seja, como todos os bens móveis e imóveis que guarneciam o local, e não havendo disposição contratual em sentido diverso, o moinho deve ser entregue ao comprador, o novo proprietário, de modo que a letra D é o nosso gabarito!**
