...
- Data Mining (Mineração de Dados): Etapas, Algoritmos e Modelos (KDD, CRISP-DM, etc.) — 11/14. Já revisado hoje ("Data Mining: fases do KDD" em Fluência de Dados CD.md, peso 4,5%, dom 0 — refaça questões do tópico).
- Conceitos de Big Data — 0/1. Amostra de 1 questão; dom já 4 na matéria.
