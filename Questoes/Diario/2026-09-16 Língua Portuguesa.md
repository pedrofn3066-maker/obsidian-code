...
tec:
obs: Dois erros, 1 questão cada (Regência Nominal e Verbal; Concordância Verbal e Nominal) — amostra insuficiente para apontar lacuna, ambos os headings já existem na nota.
---

## Erros a revisar

- Regência Nominal e Verbal (Casos Gerais) — 0/1. Amostra de 1 questão.
- Concordância (Verbal e Nominal) — 0/1. Amostra de 1 questão.
